...
class DatabaseCommon {
  static Map<String, DatabaseStaticModel> databases = {
    'cookies': DatabaseStaticModel(1, {'id':'INTEGER PRIMARY KEY','key':'TEXT','value':'TEXT'}),
    'configures':DatabaseStaticModel(1,{'id':'INTEGER PRIMARY KEY','key':'TEXT','value':'TEXT'}),
    'history':DatabaseStaticModel(1,{'id':'INTEGER PRIMARY KEY','name':'TEXT','value':'TEXT'}),
    'unread':DatabaseStaticModel(1,{'id':'INTEGER PRIMARY KEY','comicId':'TEXT','timestamp':'INTEGER'}),
    'local_history':DatabaseStaticModel(1,{'id':'INTEGER PRIMARY KEY','comicId':'TEXT','timestamp':'INTEGER','cover':'TEXT','title':'TEXT','last_chapter':'TEXT','last_chapter_id':'TEXT'}),
    'download_comic_info':DatabaseStaticModel(10,{'id':'INTEGER PRIMARY KEY','comicId':'TEXT','cover':'TEXT','title':'TEXT'}),
    'download_chapter_info':DatabaseStaticModel(10,{'id':'INTEGER PRIMARY KEY','comicId':'TEXT','chapterId':'TEXT','tasks':'TEXT','title':'TEXT','data':'TEXT'}),
    'tracking_comic_info':DatabaseStaticModel(12,{'id':'INTEGER PRIMARY KEY','comicId':'TEXT','title':'TEXT','cover':'TEXT','data':'TEXT'})
  };
